...
protected:
   ...
   Features features;
   Symbol filename;
   class__class *parent_class, *child_class;

public:
   int marked;
   SymbolTable<Symbol, M_info> *mtl;
   SymbolTable<Symbol, Entry> *atl;
   ...
   class__class *get_parent_class() { return parent_class; }
   
   class__class *get_child_class() { return child_class; }
   void set_parent_class(class__class *p) { parent_class = p; }
   void set_child_class(class__class *p) { child_class = p; }
